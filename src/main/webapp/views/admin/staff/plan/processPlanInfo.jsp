...
<% Map planInfo=(Map) request.getSession().getAttribute("processPlan"); %>
<html lang="zh-cn">
<head>
    <meta charset="UTF-8">
...
<main class="content">
    ...
    <div class="container">
        <section class="content-inner">
                        ...
                        <div class="card">
                            <div class="card-main">
                                <div class="card-inner">
                                    ...
                                    <button class="btn btn-subscription col-xx-12 col-sm-3 col-lg-2" type="button" id="cancel_plan" onclick="cancel_plan(<% out.print(planInfo.get("plan_id"));%>)">
                                        取消生产计划
                                    </button>
                                </div>
                            </div>
            ...
            <div aria-hidden="true" class="modal modal-va-middle fade" id="verify_cancel_plan_modal" role="dialog" tabindex="-1">
                <div class="modal-dialog modal-xs">
                    <div class="modal-content">
                        <div class="modal-heading">
                            <a class="modal-close" data-dismiss="modal">×</a>
                            <h2 class="modal-title">您确认取消生产计划？</h2>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        //点击取消生产计划
        cancel_plan = function (planid) {
            $("#verify_cancel_plan_modal").modal();
            planId = planid;
        };
        ...
        verify_cancel_plan = function () {
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/admin/staff/plan/staff/cancelPlan",
                dataType: "json",
                data: {
                    planId:planId,
                },
                success: function(data) {
                    ...
                    {
                        $("#result").modal();
                        document.getElementById('msg').innerHTML = "取消生产计划成功";
                    }
                    else
                    {
                        $("#result").modal();
                        document.getElementById('msg').innerHTML = "取消生产计划失败";
                    }
                },
                error:  function ()  {
                    $("#result").modal();
