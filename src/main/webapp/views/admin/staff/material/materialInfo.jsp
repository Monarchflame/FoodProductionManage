...
<% Map materialInfo=(Map) request.getSession().getAttribute("materialInfo"); %>
<html lang="zh-cn">
<head>
    <meta charset="UTF-8">
                                    ...
                                    <div class="card-table">
                                        <div class="table-responsive table-user">
                                            <table class="table table-fixed">
                                                ...
                                                <tr>
                                                    <td>库存ID</td>
                                                    <td><% out.print(materialInfo.get("inventory_id"));%></td>
                                                </tr>
                                                <tr>
                                                    <td>原材料ID</td>
                                                    <td><% out.print(materialInfo.get("material_id"));%></td>
                                                </tr>
                                                <tr>
                                                    <td>原材料名称</td>
                                                    <td><% out.print(materialInfo.get("name"));%></td>
                                                </tr>
                                                <tr>
                                                    <td>原材料库存</td>
                                                    <td><% out.print(materialInfo.get("quantity"));%></td>
                                                </tr>
                                                <tr>
                                                    <td>入库时间</td>
                                                    <td>
                                                        <% out.print(materialInfo.get("create_time"));%>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>过期时间</td>
                                                    <td>
                                                        <% out.print(materialInfo.get("expiration_time"));%>
                                                    </td>
                                                </tr>
                                                </tbody></table>
                                        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        vertify_destruction = function () {
            $.ajax({
                type: "POST",
                url: "/admin/staff/material/staff/destruction",
                dataType: "json",
                data: {
