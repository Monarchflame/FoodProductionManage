<%@ page import="cn.qxt.pojo.ProductStaff" %><%--
...
<% ProductStaff productStaff=(ProductStaff)request.getSession().getAttribute("LOGIN_USER"); %>
<html lang="zh-cn">
<head>
    <meta charset="UTF-8">
    ...
    <ul class="nav nav-list pull-right">
        <div class="dropdown margin-right">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
                <li>
                    <a class="waves-attach" href="${pageContext.request.contextPath}/admin/staff/product/staff"><span class="icon icon-lg margin-right">account_box</span>员工中心</a>
                </li>
                <li>
            ...
            <ul class="nav">
                <li>
                    ...
                    <ul class="menu-collapse collapse in" id="ui_menu_me">
                        <li>
                            <a href="${pageContext.request.contextPath}/admin/staff/product/staff"><i class="icon icon-lg">account_balance_wallet</i>&nbsp;员工中心</a>
                        </li>
                        <li>
                        ...
                        <div class="user-info-main">
                            <div class="nodemain">
                                ...
                                <div class="nodemiddle node-flex">
                                    <div class="nodetype">
                                        <% out.print(productStaff.getName());%>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card user-info">
                        <div class="user-info-main">
                            <div class="nodemain">
                                ...
                                <div class="nodemiddle node-flex">
                                    <div class="nodetype">
                                        <% out.print(productStaff.getPosition());%>
                                    </div>
                                </div>
                            </div>
                            <div class="nodestatus">
