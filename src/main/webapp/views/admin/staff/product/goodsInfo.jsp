                        ...
                        <div class="card">
                            <div class="card-main">
                                <div class="card-inner">
                                    ...
                                    <button class="btn btn-subscription col-xx-12 col-sm-3 col-lg-2" type="button" id="cancel_plan" onclick="destruction(<% out.print(goodsInfo.get("goods_id"));%>)">
                                        销毁
                                    </button>
                                </div>
                            </div>
                ...
                <div class="modal-dialog modal-xs">
                    <div class="modal-content">
                        <div class="modal-heading">
                            ...
                            <h2 class="modal-title">您确认销毁该库存？</h2>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        verify_destruction = function () {
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/admin/staff/product/staff/destroy",
                dataType: "json",
                data: {
                    goodsId:goodsId,
                },
