                            ...
                            <div class="card-inner ui-switch">
                                <div class="switch-btn" id="switch-cards">
                                    <a href="#" onclick="javascript:UIchange();">
                                        <i class="mdui-icon product-icons">apps</i>
                                    </a>
                                </div>
                                <div class="switch-btn" id="switch-table">
                                    <a href="#" onclick="javascript:UIchange();">
                                        <i class="mdui-icon product-icons">dehaze</i>
                                    </a>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
        $.ajax({
            type: "POST",
            url: "/admin/staff/product/staff/allGoodsInfoList",
            dataType: "json",
            data: {
            },
            //查询商品及客户信息返回相应数据
            success: function(data){
                var list = eval(data.goodsInfoList);
                var productHTML = [];
                for(var i = 0;i < list.length;i++) {
                    ...
                    productHTML.push(
                        '<div class="card">' +
                        '<div class="card-main">' +
                        '<div class="shop-name">'+'产品ID:'+ product.product_id +'</div>' +
                        '<div class="shop-content">' +
                        '<div class="shop-content-left">'+'产品名称:'+'</div>' +
                        '<div class="shop-content-right">'+product.product_name+'</div>' +
    ...
    $("#order_verify").click(function () {
        $.ajax({
            type: "POST",
            url: "/admin/staff/product/staff/addGoods",
            dataType: "json",
            data: {
