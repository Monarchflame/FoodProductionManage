            ...
            <ul class="nav">
                <li>
                    ...
                    <ul class="menu-collapse collapse in" id="ui_menu_finance">
                        <li>
                            <a href=" "><i class="icon icon-lg">account_box</i>&nbsp;查看账单</a>
                        </li>
                    </ul>
            </ul>
        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/admin/staff/finance/staff/bill",
            dataType: "json",
            data: {
            },
            //查询商品及客户信息返回相应数据
    ...
    function financeInfo(id) {
        document.getElementById('infoifram').src = '${pageContext.request.contextPath}/admin/staff/finance/staff/financeInfo?id=' + id;
        $("#orderinfo").modal();
    }
</script>