...
<% Map financeInfo=(Map) request.getSession().getAttribute("financeInfo"); %>
<html lang="zh-cn">
<head>
    <meta charset="UTF-8">
                                    ...
                                    <div class="card-table">
                                        <div class="table-responsive table-user">
                                            <table class="table table-fixed">
                                                ...
                                                <tr>
                                                    <td>账单编号</td>
                                                    <td><% out.print(financeInfo.get("finance_id"));%></td>
                                                </tr>
                                                <tr>
                                                    <td>交易金额</td>
                                                    <td><% out.print(financeInfo.get("money"));%></td>
                                                </tr>
                                                <tr>
                                                    <td>交易类型</td>
                                                    <td><% out.print(financeInfo.get("type"));%></td>
                                                </tr>
                                                <tr>
                                                    <td>订单编号</td>
                                                    <td><% out.print(financeInfo.get("order_id"));%></td>
                                                </tr>
                                                <tr>
                                                    <td>交易者姓名</td>
                                                    <td>
                                                        <% out.print(financeInfo.get("user_name"));%>
                                                    </td>
                                                </tr>
                                                </tbody></table>
                                        </div>
