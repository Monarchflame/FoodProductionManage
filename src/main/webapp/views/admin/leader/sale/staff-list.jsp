    ...
    <ul class="nav nav-list pull-right">
        <div class="dropdown margin-right">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
                <li>
                    <a class="waves-attach" href="admin/leader/sale/leader"><span class="icon icon-lg margin-right">account_box</span>员工中心</a>
                </li>
                <li>
            ...
            <ul class="nav">
                <li>
                    ...
                    <ul class="menu-collapse collapse in" id="ui_menu_me">
                        <li>
                            <a href="admin/leader/sale/leader"><i class="icon icon-lg">account_balance_wallet</i>&nbsp;员工中心</a>
                        </li>
                        <li>
                    ...
                    <ul class="menu-collapse collapse in" id="ui_menu_sale">
                        <li>
                            <a href="/admin/leader/sale/leader/order-list"><i class="icon icon-lg">account_box</i>&nbsp;查看订单</a>
                        </li>
                        <li>
                            <a href="/admin/leader/sale/leader/staff-list"><i class="icon icon-lg">account_box</i>&nbsp;查看员工</a>
                        </li>
                    </ul>
            </ul>
        </div>
...
<script>
    $(document).ready(function () {
        $.ajax({
            type: "POST",
            url: "/admin/leader/sale/leader/allStaffInfo",
            dataType: "json",
            async:false,
            data: {
            },
        ...
        staffInfo = function (id) {
            document.getElementById('infoifram').src = '/admin/leader/sale/leader/staffInfo?staffId=' + id;
            $("#staffinfo").modal();
        }
    });
</script>
