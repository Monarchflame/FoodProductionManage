...
<script>
    $(document).ready(function () {
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/admin/leader/product/leader/allStaffInfo",
            dataType: "json",
            async:false,
            data: {
            },
        ...
        staffInfo = function (id) {
            document.getElementById('infoifram').src = '${pageContext.request.contextPath}/admin/leader/product/leader/staffInfo?staffId=' + id;
            $("#staffinfo").modal();
        }
    });
</script>
