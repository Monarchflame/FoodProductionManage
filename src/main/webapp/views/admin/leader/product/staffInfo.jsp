...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        verify_changeSalary = function () {
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/admin/leader/product/leader/changeSalary",
                dataType: "json",
                data: {
                    staffId:staffId,
        ...
        verify_changePosition = function () {
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/admin/leader/product/leader/changePosition",
                dataType: "json",
                data: {
                    staffId:staffId,
