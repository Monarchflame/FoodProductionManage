...
<% Map orderInfo=(Map) request.getSession().getAttribute("processOrder"); %>
<html lang="zh-cn">
<head>
    <meta charset="UTF-8">
                                        ...
                                        <div class="table-responsive table-user">
                                            <table class="table table-fixed">
                                                ...
                                                <tr>
                                                    <td>客户</td>
                                                    <td>
                                                        <% out.print(orderInfo.get("client_name"));%>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>地址</td>
                                                    <td>
                                                        <% out.print(orderInfo.get("address"));%>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>客户类型</td>
                                                    <td>
                                                        <% out.print(orderInfo.get("client_type"));%>
                                                    </td>
                                                </tr>
                                                </tbody></table>
                                        </div>
                                    </div>
                                    <button class="btn btn-subscription col-xx-12 col-sm-3 col-lg-2" type="button" id="take_plan" onclick="deliver_order(<% out.print(orderInfo.get("order_id"));%>)">
                                        交由生产计划科安排生产
                                    </button>
                ...
                <div class="modal-dialog modal-xs">
                    <div class="modal-content">
                        <div class="modal-heading">
                            ...
                            <h2 class="modal-title">您确认将订单交由生产计划科？</h2>
                        </div>
            ...
            <div aria-hidden="true" class="modal modal-va-middle fade" id="verify_deliver_goods_modal" role="dialog" tabindex="-1">
                <div class="modal-dialog modal-xs">
                    <div class="modal-content">
                        <div class="modal-heading">
                            <a class="modal-close" data-dismiss="modal">×</a>
                            <h2 class="modal-title">您确认安排发货？</h2>
                        </div>
                        <div class="modal-footer">
                            <p class="text-right">
...
<script type="text/javascript">
    $(document).ready(function () {
        //点击将订单交给生产计划科
        deliver_order = function (orderid) {
        ...
        verify_deliver_order = function () {
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/admin/staff/sale/staff/deliverOrder",
                dataType: "json",
                data: {
                    orderId:orderId,
                },
