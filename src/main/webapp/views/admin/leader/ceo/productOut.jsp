...
<script type="text/javascript">
    $(document).ready(function(){
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/admin/staff/product/staff/readyDeliverOrderList",
            dataType: "json",
            data: {
            },
            //查询商品及客户信息返回相应数据
    ...
    function readyDeliverOrder(id) {
        document.getElementById('infoifram').src = '${pageContext.request.contextPath}/admin/staff/product/staff/readyDeliverOrderInfo?orderId=' + id;
        $("#orderinfo").modal();
    }
</script>