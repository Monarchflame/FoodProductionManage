                ...
                <div class="modal-dialog modal-xs">
                    <div class="modal-content">
                        <div class="modal-heading">
                            ...
                            <h2 class="modal-title">您确认同意退款？</h2>
                        </div>
            ...
            <div aria-hidden="true" class="modal modal-va-middle fade" id="verify_deliver_goods_modal" role="dialog" tabindex="-1">
                <div class="modal-dialog modal-xs">
                    <div class="modal-content">
                        <div class="modal-heading">
                            <a class="modal-close" data-dismiss="modal">×</a>
                            <h2 class="modal-title">您确认拒绝退款？</h2>
                        </div>
                        <div class="modal-footer">
                            <p class="text-right">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        verify_agree = function () {
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/admin/staff/finance/staff/agreeRefund",
                dataType: "json",
                data: {
                    goodsReturnOrderId:id,
                },
        ...
        verify_disagree = function () {
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/admin/staff/finance/staff/disagreeRefund",
                dataType: "json",
                data: {
                    goodsReturnOrderId:id,
                },
