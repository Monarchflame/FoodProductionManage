            ...
            <ul class="nav">
                <li>
                    ...
                    <ul class="menu-collapse collapse in" id="ui_menu_me">
                        <li>
                            <a href="/admin/leader/finance/leader"><i class="icon icon-lg">account_balance_wallet</i>&nbsp;员工中心</a>
                        </li>
                        <li>
...
<script>
    $(document).ready(function () {
        ...
        staffInfo = function (id) {
            document.getElementById('infoifram').src = '/admin/leader/finance/leader/staffInfo?staffId=' + id;
            $("#staffinfo").modal();
        }
    });
</script>
