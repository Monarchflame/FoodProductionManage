        ...
        <div class="menu-content">
            ...
            <ul class="nav">
                <li>
                    ...
                    <a class="waves-attach" data-toggle="collapse" href="#ui_menu_material">生产车间</a>
                    <ul class="menu-collapse collapse in" id="ui_menu_material">
                        <li>
                            <a href="/admin/leader/material/leader/material-list"><i class="icon icon-lg">account_box</i>&nbsp;查看原材料库存</a>
                        </li>
                        <li>
                            <a href="/admin/leader/material/leader/material-record"><i class="icon icon-lg">account_box</i>&nbsp;查看原材料记录</a></li>
                        <li>
                            <a href="/admin/leader/material/leader/staff-list"><i class="icon icon-lg">account_box</i>&nbsp;查看员工</a>
                        </li>
                    </ul>
            </ul>
        </div>
...
<script>
    $(document).ready(function () {
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/admin/leader/material/leader/allStaffInfo",
            dataType: "json",
            async:false,
            data: {
            },
        ...
        staffInfo = function (id) {
            document.getElementById('infoifram').src = '/admin/leader/material/leader/staffInfo?staffId=' + id;
            $("#staffinfo").modal();
        }
    });
</script>
