...
<script>
    $(document).ready(function () {
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/admin/leader/workshop/leader/allStaffInfo",
            dataType: "json",
            async:false,
            data: {
            },
        ...
        staffInfo = function (id) {
            document.getElementById('infoifram').src = '${pageContext.request.contextPath}/admin/leader/workshop/leader/staffInfo?staffId=' + id;
            $("#staffinfo").modal();
        }
    });
</script>
