        ...
        <ul class="nav nav-list pull-right">
            <div class="dropdown margin-right">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    <li>
                        <a class="waves-attach" href="/admin/staff/material/staff"><span class="icon icon-lg margin-right">account_box</span>员工中心</a>
                    </li>
                    <li>
                ...
                <ul class="nav">
                    <li>
                        ...
                        <ul class="menu-collapse collapse in" id="ui_menu_me">
                            <li>
                                <a href="/admin/staff/material/staff"><i class="icon icon-lg">account_balance_wallet</i>&nbsp;员工中心</a>
                            </li>
                            <li>
