...
<body class="page-orange" style="background-image: url(${pageContext.request.contextPath}/images/abackground1.jpg)" >
    ...
    $(document).ready(function(){
        $("#andMaterial").click(function () {
            ...
            else
            {
                $.ajax({
                    type: "POST",
                    url: "${pageContext.request.contextPath}/admin/staff/material/staff/addMaterial",
                    dataType: "json",
                    data: {
                        name:name,
