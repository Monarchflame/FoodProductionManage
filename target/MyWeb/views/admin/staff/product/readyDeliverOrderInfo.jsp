...
<% Map orderInfo=(Map) request.getSession().getAttribute("readyDeliverOrderInfo"); %>
<html lang="zh-cn">
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="card">
                            <div class="card-main">
                                <div class="card-inner">
                                    ...
                                    <button class="btn btn-subscription col-xx-12 col-sm-3 col-lg-2" type="button" id="cancel_plan" onclick="deliver_goods(<% out.print(orderInfo.get("order_id"));%>)">
                                        发货
                                    </button>
                                </div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        verify_deliver_goods = function () {
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/admin/staff/product/staff/ship",
                dataType: "json",
                data: {
                    orderId:orderId,
                },
