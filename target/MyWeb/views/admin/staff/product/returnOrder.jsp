...
<script type="text/javascript">
    $(document).ready(function(){
        $.ajax({
            type: "POST",
            url: "/admin/staff/product/staff/inReturnOrderList",
            dataType: "json",
            data: {
            },
            //查询商品及客户信息返回相应数据
    ...
    function inReturnOrder(id) {
        document.getElementById('infoifram').src = '/admin/staff/product/staff/inReturnOrderInfo?goodsReturnOrderId=' + id;
        $("#orderinfo").modal();
    }
</script>
