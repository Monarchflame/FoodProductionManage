            ...
            <ul class="nav">
                <li>
                    ...
                    <ul class="menu-collapse collapse in" id="ui_menu_me">
                        <li>
                            <a href="${pageContext.request.contextPath}/admin/staff/plan/staff"><i class="icon icon-lg">account_balance_wallet</i>&nbsp;员工中心</a>
                        </li>
                        <li>
...
<script>
    $(document).ready(function(){
        ...
        processPlan = function (id) {
            document.getElementById('infoifram').src = '${pageContext.request.contextPath}/admin/staff/plan/staff/processPlanInfo?id=' + id;
            $("#planinfo").modal();
        }
    })
</script>
